...
from youtube_get.utils.helpers import install_proxy
...
class YouTube:
    ...
    def __init__(
        ...
        :param func on_progress_callback:
            (Optional) User defined callback function for stream download progress events.
        :param func on_complete_callback:
            (Optional) User defined callback function for stream download complete events.
        :param dict proxies:
    ...
    def __repr__(self):
        return f'<YouTube object: videoId={self.video_id}>'
    ...
    def js(self):
        ...
        if youtube_get.__js_url__ != self.js_url:
            self._js = request.get(self.js_url)
            youtube_get.__js__ = self._js
            youtube_get.__js_url__ = self.js_url
        else:
            self._js = youtube_get.__js__
    ...
    def fmt_streams(self):
        ...
        try:
            ...
            self._js = None
            self._js_url = None
            youtube_get.__js__ = None
            youtube_get.__js_url__ = None
            extract.apply_signature(stream_manifest, self.vid_info, self.js)
