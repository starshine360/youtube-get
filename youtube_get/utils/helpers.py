"""Various helper functions are implemented here."""
...
class DeferredGeneratorList:
    ...
    There may be some continuation generators that create web calls, which means
    ...
    def __init__(self, generator):
        """
        Args:
            generator (generator): The deferrable generator to create a wrapper for.
        """
        self.gen = generator
        self._elements = []
...
def regex_search(pattern: str, string: str, group: int) -> str:
    ...
    Returns:
        A str or tuple, which is the substring pattern matches.
    """
...
def uniqueify(duped_list: List) -> List:
    ...
    Args:
        duped_list (list): List to remove duplicates from
